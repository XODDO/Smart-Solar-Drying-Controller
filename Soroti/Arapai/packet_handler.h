...
extern float average_wind_sp;
extern uint16_t average_solar_rad;
extern char sensor_13_last_seen[12];
...
private:
    ...
    static const int PACKET_STACK_SIZE = 8192;//16384; // 16KB,  it only uses up to 1,816
